            ...
            <div className="space-y-6 p-4 md:p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-red-600">{pagination?.total || 0}</div>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-red-700">
                                {errorLogs?.filter(log => ['critical', 'alert', 'emergency'].includes(log.level)).length || 0}
                            </div>
                            <p className="text-xs text-slate-500 mt-1">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Error Entries ({pagination?.total || 0})</CardTitle>
                    </CardHeader>
                    <CardContent>
