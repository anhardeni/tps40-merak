...
import { Anchor, Mountain, Warehouse } from 'lucide-react';
                    ...
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                            <div className="flex lg:col-start-2 lg:justify-center">
                                <div className="flex gap-4 text-white lg:text-[#FF2D20]">
                                    <Anchor className="h-12 w-12 lg:h-16 lg:w-16" />
                                    <Warehouse className="h-12 w-12 lg:h-16 lg:w-16" />
                                    <Mountain className="h-12 w-12 lg:h-16 lg:w-16" />
                                </div>
                            </div>
