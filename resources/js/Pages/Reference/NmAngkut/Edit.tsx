...
export default function NmAngkutEdit({ nmAngkut }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        is_active: nmAngkut.is_active ?? true,
    })

    const handleSubmit = (e: FormEvent) => {
        e.preventDefault()
        put(`/reference/nm-angkut/${nmAngkut.id}`)
    }

    return (
        <AuthenticatedLayout>
            <Head title="Edit Nama Angkutan" />
                    ...
                    <Card>
                        <CardHeader>
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <CardTitle>Edit Nama Angkutan</CardTitle>
                                    <CardDescription>Edit data angkutan: {nmAngkut.nm_angkut}</CardDescription>
                                </div>
                            </div>
                        </CardHeader>
                        <CardContent>
